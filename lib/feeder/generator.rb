  ...
  class Generator
    ...
    class << self
      def inherited(subclass)
        ...
        Feeder::Registry.register(subclass)
      end
    ...
    def create_feed!(payload)
      if @owner
        ...
        Feeder::Feed.create!(feed_type: self.class.feed_type, period_name: period_name, data: payload)
      end
    end

    def feed_scope
      @owner.public_send(Feeder.configuration.association_name)
    end
  end
end
